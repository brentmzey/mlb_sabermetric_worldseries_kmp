...
fun generateRosterAnchorsChartImage(topTeams: List<TeamProbability>, seasonYear: Int) {
    ...
    val rosterAnchorsMap = mapOf(
        MlbTeamId.LAD to "Ohtani, Betts, Freeman, Yamamoto, Flaherty, Buehler",
        MlbTeamId.ATL to "Sale, Olson, Ozuna, Schwellenbach, Lopez, Harris II",
        MlbTeamId.NYY to "Judge, Soto, Cole, Rodón, Chisholm Jr., Gil",
        MlbTeamId.MIL to "Chourio, Contreras, Frelick, Turang, Peralta, Megill",
        MlbTeamId.CHC to "PCA, Happ, Busch, Swanson, Imanaga, Taillon, Hodge",
        MlbTeamId.TBD to "Díaz, Lowe, Caminero, Bradley, Baz, Fairbanks",
        MlbTeamId.HOU to "Alvarez, Altuve, Bregman, Valdez, Brown, Hader",
        MlbTeamId.DET to "Skubal, Greene, Carpenter, Keith, Holton, Foley",
        MlbTeamId.SD  to "Tatis Jr., Machado, Merrill, Cease, King, Suarez",
        MlbTeamId.BOS to "Devers, Duran, Casas, Gray, Houck, Crawford",
        MlbTeamId.PHI to "Harper, Turner, Schwarber, Wheeler, Nola, Sánchez",
        MlbTeamId.TEX to "Seager, Semien, Nimmo, Eovaldi, deGrom, Yates",
        MlbTeamId.ARI to "Marte, Carroll, Arenado, Gallen, Kelly, Sewald",
        MlbTeamId.MIN to "Correa, Lewis, Buxton, López, Ober, Duran",
        MlbTeamId.CLE to "Ramírez, Naylor, Kwan, Bibee, Williams, Clase",
        MlbTeamId.TOR to "Guerrero Jr., Bichette, Varsho, Gausman, Berríos",
        MlbTeamId.STL to "Báez, Walker, Donovan, Fedde, Gibson, Helsley",
        MlbTeamId.BAL to "Henderson, Rutschman, Santander, Burnes, Rodriguez, Eflin",
        MlbTeamId.CWS to "Robert Jr., Benintendi, Vaughn, Crochet, Martin, Kuhl",
        MlbTeamId.SEA to "Rodríguez, Raleigh, Arozarena, Kirby, Gilbert, Muñoz",
        MlbTeamId.KC  to "Witt Jr., Perez, Pasquantino, Ragans, Lugo, Erceg",
        MlbTeamId.OAK to "Rooker, Butler, Bleday, Langeliers, Sears, Miller",
        MlbTeamId.LAA to "Trout, Neto, O'Hoppe, Ward, Anderson, Joyce",
        MlbTeamId.NYM to "Lindor, Alonso, Martinez, Senga, Manaea, Díaz",
        MlbTeamId.WSH to "Abrams, Wood, Crews, Gore, Parker, Finnegan",
        MlbTeamId.MIA to "Burger, Lopez, Edwards, Cabrera, Faucher, Bender",
        MlbTeamId.CIN to "De La Cruz, Steer, McLain, Greene, Lodolo, Díaz",
        MlbTeamId.PIT to "Skenes, Keller, Jones, Reynolds, Cruz, Bednar",
        MlbTeamId.SF  to "Chapman, Ramos, Lee, Webb, Ray, Walker",
        MlbTeamId.COL to "Tovar, Doyle, McMahon, Jones, Freeland, Kinley"
    )
