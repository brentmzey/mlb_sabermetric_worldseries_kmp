...
fun generateRosterAnchorsChartImage(topTeams: List<TeamProbability>, seasonYear: Int) {
    ...
    val rosterAnchorsMap = mapOf(
        ...
        MlbTeamId.CLE to "Ramírez, Naylor, Kwan, Bibee, Clase",
        MlbTeamId.TOR to "Guerrero Jr., Bichette, Varsho, Gausman, Berríos",
        MlbTeamId.STL to "Báez, Walker, Donovan, Fedde, Helsley",
        MlbTeamId.BAL to "Henderson, Rutschman, Santander, Burnes, Rodriguez",
        MlbTeamId.CWS to "Robert Jr., Benintendi, Vaughn, Crochet, Kuhl",
        ...
        MlbTeamId.NYM to "Lindor, Alonso, Nimmo, Senga, Manaea, Díaz",
        MlbTeamId.WSH to "Abrams, Wood, Crews, Gore, Finnegan",
        MlbTeamId.MIA to "Burger, Lopez, Edwards, Cabrera, Faucher",
        MlbTeamId.CIN to "De La Cruz, Steer, McLain, Greene, Díaz",
        MlbTeamId.PIT to "Skenes, Keller, Jones, Reynolds, Cruz",
        MlbTeamId.SF  to "Chapman, Ramos, Lee, Webb, Ray, Walker",
        MlbTeamId.COL to "Tovar, Doyle, Jones, Freeland"
    )
