...
object SabermetricDataService {
    ...
    fun loadCleanedMlbDataset(): List<MlbTeam> {
        val dataset = listOf(
            ...
            MlbTeam(MlbTeamId.ATL, 75, 53, 608.0, 496.0, 27.5, 0.310, 100.0, 3.78, 3.82, 1.8, 3.35, 0.6, 0.98, 4, 6, 1.035, 0.180, 1.01, 1.14, 1.02, 0.98, 1.02, 1.04, 1.02),
            ...
            // --- NL CENTRAL ---
            MlbTeam(MlbTeamId.MIL, 79, 49, 642.0, 483.0, 35.8, 0.325, 108.0, 3.62, 3.68, 3.5, 3.35, 1.8, 1.10, 5, 5, 1.032, 0.100, 1.08, 1.20, 1.08, 1.06, 1.09, 1.08, 1.11),
