...
object SabermetricDataService {
    ...
    fun loadCleanedMlbDataset(): List<MlbTeam> {
        val dataset = listOf(
            ...
            MlbTeam(MlbTeamId.ATL, 73, 48, 591.0, 467.0, 34.5, 0.320, 106.0, 3.52, 3.58, 3.8, 2.75, 2.8, 1.12, 7, 3, 1.038, 0.175, 1.16, 1.18, 1.05, 1.08, 1.05, 1.15, 1.12),
            ...
            // --- NL CENTRAL ---
            MlbTeam(MlbTeamId.MIL, 74, 47, 592.0, 462.0, 35.5, 0.325, 108.0, 3.62, 3.68, 3.5, 3.40, 1.8, 1.10, 5, 5, 1.040, 0.085, 1.08, 1.10, 1.08, 1.06, 1.09, 1.08, 1.11),
            ...
            // --- NL WEST ---
            MlbTeam(MlbTeamId.LAD, 72, 48, 602.0, 462.0, 40.0, 0.338, 120.0, 3.62, 3.68, 3.8, 3.10, 3.2, 1.25, 3, 7, 1.025, 0.235, 1.20, 1.24, 1.06, 1.18, 1.06, 1.18, 1.15),
