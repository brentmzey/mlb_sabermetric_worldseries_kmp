...
object SabermetricDataService {
    ...
    fun loadCleanedMlbDataset(): List<MlbTeam> {
        val dataset = listOf(
            ...
            MlbTeam(MlbTeamId.BAL, 58, 63, 543.0, 579.0, 24.2, 0.312, 101.0, 4.18, 4.22, -0.4, 4.15, 0.5, 1.00, 4, 6, 1.033, 0.065, 1.06, 1.05, 1.04, 1.02, 1.03, 0.98, 0.98),
            ...
            // --- AL CENTRAL ---
            MlbTeam(MlbTeamId.CLE, 59, 62, 483.0, 510.0, 31.0, 0.308, 98.0, 3.65, 3.75, 4.2, 3.28, 1.2, 1.03, 3, 7, 1.030, 0.012, 0.99, 0.99, 1.12, 0.98, 1.14, 1.06, 1.12),
            ...
            MlbTeam(MlbTeamId.ATL, 73, 48, 591.0, 467.0, 34.5, 0.320, 106.0, 3.52, 3.58, 3.8, 2.95, 2.8, 1.12, 7, 3, 1.038, 0.175, 1.16, 1.18, 1.05, 1.08, 1.05, 1.15, 1.12),
            ...
            // --- NL CENTRAL ---
            MlbTeam(MlbTeamId.MIL, 74, 47, 592.0, 462.0, 35.5, 0.325, 108.0, 3.62, 3.68, 3.5, 3.30, 1.8, 1.12, 5, 5, 1.040, 0.085, 1.08, 1.10, 1.08, 1.08, 1.09, 1.10, 1.11),
            MlbTeam(MlbTeamId.CHC, 71, 50, 634.0, 519.0, 33.5, 0.325, 108.0, 3.72, 3.78, 2.8, 3.20, 1.8, 1.10, 8, 2, 1.037, 0.075, 1.10, 1.12, 1.07, 1.08, 1.08, 1.09, 1.08),
            ...
            // --- NL WEST ---
            MlbTeam(MlbTeamId.LAD, 72, 48, 602.0, 462.0, 40.0, 0.338, 120.0, 3.62, 3.68, 3.8, 2.65, 3.2, 1.25, 3, 7, 1.025, 0.235, 1.20, 1.24, 1.06, 1.18, 1.06, 1.22, 1.15),
