...
- **NL Pennant Probability**: **16.5%**
- **World Series Win Probability**: **10.12%** (#5 overall favorite in MLB out of 30 teams)

---

## 🧮 1. The 5 Structural & Econometric Factors

### Factor 1: 4-Pillar Whole-Season Consistency (1.075) & Defense (1.07)
...
- **Starting Rotation (1.08)**: 3.28 Top-3 Ace ERA (Shota Imanaga, Jameson Taillon, Javier Assad). *Note: Justin Steele is excluded due to season-ending injury.*
...
### Factor 4: National League "Superteam" Landscape (Braves & Dodgers)
To win the World Series out of the NL, contenders must compete against:
1. **Atlanta Braves (73–48, 21.19% WS Prob)**: #1 in MLB. 1.103 4-pillar consistency, 2.75 Ace ERA, +400 Vegas futures.
2. **Los Angeles Dodgers (72–48, 18.65% WS Prob)**: #2 in MLB. 1.150 4-pillar consistency, 3.10 Ace ERA, +350 Vegas futures.
...
$$P(\text{CHC beats LAD}) = \frac{q_{\text{CHC}}^{1.45}}{q_{\text{CHC}}^{1.45} + q_{\text{LAD}}^{1.45}} \approx 47.3\%$$
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Wild Card Baseline (Current)** | 2nd Place (Wild Card 1) | Seed 4 | Wild Card Round | 98.2 | **10.12%** |
| **Cubs Overtake Milwaukee (Division Title)** | **1st Place (NL Central)** | **Seed 2** | **First-Round Bye** | **100.4** | **17.20%** |

*Takeaway*: Incorporating Bill James' Log5 theorem and Brian Kenny's rotation compression places the Cubs at **#5 in ALL OF MLB with a 10.12% World Series Win Probability**. If they overtake Milwaukee for the NL Central title and secure a First-Round Bye, their championship odds **jump to ~17.2%**!
